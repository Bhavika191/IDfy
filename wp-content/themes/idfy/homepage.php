...
<section class="bannerSectionhp">
    ...
    <div class="bannerWrapper">
        <div class="bannerBg">
            ...
            <img src="<?php echo esc_url($bannerimage['url']); ?>" loading="lazy"
        ...
        <div class="enterpriseLogos">
            <div class="logoDiv">
                ...
                <div class="innerBoxes">
                    ...
                    <img src="<?php echo esc_url($companylogo['url']); ?>" loading="lazy"
                        alt="<?php echo esc_attr($companylogo['alt']); ?>" />
                    <?php endif; ?>
                </div>
                <?php endwhile; ?>
                <?php endif; ?>
        ...
        <div class="pioneerSlider">
            ...
            <div class="innerSlides">
                <div class="contentDiv">
                    <h3>
                        <?php echo get_sub_field('card_heading'); ?>
                    </h3>
                    <p>
                    ...
                    <?php $value = get_sub_field("card_cta_text");
                                    if ($value) { ?>
                    <a href="<?php echo get_sub_field('card_cta_link'); ?>" class="ctaRed" target="_blank">
                        <?php echo get_sub_field('card_cta_text'); ?>
                    </a>
                    <?php } ?>
                ...
                <div class="imageDiv">
                    <div class="mainImg">
                        <?php $pioneerimg = get_sub_field('card_image');
                                        if (!empty($pioneerimg)) : ?>
                        <img src="<?php echo esc_url($pioneerimg['url']); ?>" loading="lazy"
                            alt="<?php echo esc_attr($pioneerimg['alt']); ?>" />
                        <?php endif; ?>
                    </div>
                    <div class="dots">
    ...
    <div class="innerWrapper">
        <div class="secHeading">
            ...
            <?php $valuetwo = get_sub_field("cta_link");
                    if ($valuetwo) { ?>
            <a href="<?php echo get_sub_field('cta_link'); ?>" class="ctaRed">
            ...
            <div class="contentDiv">
                ...
                <div class="innerBoxes">
                    ...
                    <div class="journeyinnerData">
                        <h4>
                            <?php echo get_sub_field('card_pointers_heading'); ?>
                        </h4>
                        <ul>
                ...
                <div class="outerborderDiv">
                    <div class="mainImg">
                        <?php $circleimg = get_sub_field('circle_image');
                                if (!empty($circleimg)) : ?>
                        <img src="<?php echo esc_url($circleimg['url']); ?>" loading="lazy"
                            alt="<?php echo esc_attr($circleimg['alt']); ?>" />
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="journeyIcons">
                        <?php $iconfield = get_sub_field('icon_field');
                                        if (!empty($iconfield)) : ?>
                        <img src="<?php echo esc_url($iconfield['url']); ?>" loading="lazy"
                            alt="<?php echo esc_attr($iconfield['alt']); ?>" />
                        <?php endif; ?>
                    </div>
                    <?php endwhile; ?>
                    <?php endif; ?>
                        ...
                        <li class="tab" id="tabDiv" data-slide="<?php echo $counter; ?>">
                            <h3>
                                ...
                                <?php $valuenew = get_sub_field("new_tag");
                                                if ($valuenew) { ?>
                                <span>
                                    <?php echo get_sub_field('new_tag'); ?>
                                </span>
                                <?php } ?>
                            </h3>
                        </li>
                    ...
                    <div class="scroll-cards__item slide" aria-label="Wie - 1" data-slide="<?php echo $counter; ?>">
                        <div class="dataImg">
                            <?php $profamimg = get_sub_field('card_image');
                                            if (!empty($profamimg)) : ?>
                            <img src="<?php echo esc_url($profamimg['url']); ?>" loading="lazy"
                                alt="<?php echo esc_attr($profamimg['alt']); ?>" />
                            <?php endif; ?>
                        </div>
                        <div class="dataContent">
                            ...
                            <h3>
                                <?php echo get_sub_field('card_intro_heading'); ?>
                            </h3>
                            <p>
                                <?php echo get_sub_field('card_description'); ?>
                            </p>
        ...
        <div class="boxContent">
            <div class="box-container">
                ...
                <div class="box boxContent " id="boxesData">
                    ...
                    <a href="<?php echo get_sub_field('cta_link'); ?>" class="ctaBlue">
                        <?php echo get_sub_field('cta_text'); ?>
                    </a>
                </div>
                <div class="boxContent">
                ...
                <?php $counter = 1;
                            while (have_rows('fraud_stories_content')) : the_row(); ?>
                                <div class="box boxImgnew  fraudstory<?php echo $counter; ?> <?php if ($counter == 1) {
                                    ...
                                    if (!empty($fraudimg)) : ?>
                    <img src="<?php echo esc_url($fraudimg['url']); ?>" loading="lazy"
                        alt="<?php echo esc_attr($fraudimg['alt']); ?>" />
                    <?php endif; ?>
                    <div class="dotsInner">
                ...
                <div class="imgnameDiv">
                    <div class="imgBox">
                        <?php $clientimg = get_sub_field('client_image');
                                        if (!empty($clientimg)) : ?>
                        <img src="<?php echo esc_url($clientimg['url']); ?>" loading="lazy"
                            alt="<?php echo esc_attr($clientimg['alt']); ?>" />
                        <?php endif; ?>
                        <div class="dotsInner">
                    ...
                    <div class="nameDiv">
                        ...
                        <h5>
                            <?php echo get_sub_field('clients_designation'); ?>
                        </h5>
                    </div>
                </div>
                <div class="contentDiv">
                    <h3>
                        <?php echo get_sub_field('clients_review_text'); ?>"
                    </h3>
                </div>
            </div>
            <?php endwhile; ?>
                ...
                <div class="imgBox">
                    <div class="imgDiv">
                        <?php $awardlogo = get_sub_field('award_logo');
                                        if (!empty($awardlogo)) : ?>
                        <img src="<?php echo esc_url($awardlogo['url']); ?>" loading="lazy"
                            alt="<?php echo esc_attr($awardlogo['alt']); ?>" />
                        <?php endif; ?>
                    </div>
                    <div class="contentDiv">
                        <h3>
                            <?php echo get_sub_field('award_name'); ?>
                        </h3>
                    </div>
                </div>
                <?php endwhile; ?>
            ...
            <div class="certificateDiv">
                ...
                <div class="imgBox">
                    <div class="imgDiv">
                        ...
                        <img src="<?php echo esc_url($certificateslogo['url']); ?>" loading="lazy"
                            alt="<?php echo esc_attr($certificateslogo['alt']); ?>" />
                        <?php endif; ?>
                    </div>
                    <div class="contentDiv">
                        <h3>
                            <?php echo get_sub_field('certificates_name'); ?>
                        </h3>
                    </div>
                </div>
                <?php endwhile; ?>
